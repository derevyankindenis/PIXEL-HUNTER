...
```bash
git clone git@github.com:htmlacademy-ecmascript/pixel-hunter.git
```

Адрес в команде нужно заменить на тот, что вы скопировали. Теперь в папке `pixel-hunter` лежит ваш проект.
...
git remote add academy git@github.com:htmlacademy-ecmascript/113198-pixel-hunter.git
```
